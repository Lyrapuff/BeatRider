...
namespace YouTubeSearch
{
    ...
    public class ButtonRendererServiceEndpoint
    {
        [JsonProperty("clickTrackingParams", NullValueHandling = NullValueHandling.Ignore)]
        public string ClickTrackingParams { get; set; }
    ...
    public class ThumbnailThumbnail
    {
        [JsonProperty("url", NullValueHandling = NullValueHandling.Ignore)]
        public string Url { get; set; }
    ...
    public class PtrackingUrlClass
    {
        [JsonProperty("baseUrl", NullValueHandling = NullValueHandling.Ignore)]
        public string BaseUrl { get; set; }
    }
    ...
    public partial class Model
    {
        ...
        {
            return JsonConvert.DeserializeObject<Model>(json, Converter.Settings);
        }
    }

    public static class Serialize
    {
        public static string ToJson(this Model self)
        {
